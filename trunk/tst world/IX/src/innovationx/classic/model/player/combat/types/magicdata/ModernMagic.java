package src.innovationx.classic.model.player.combat.types.magicdata;
...
public enum ModernMagic {
	...
	ModernMagic(int[] data) {
		magicData = data;
		Server.s.combatInstance.data.data.put(this.name(), magicData);
	}
	...
	public static int[] getData(String name) {
		for(ModernMagic m : ModernMagic.values()) {
